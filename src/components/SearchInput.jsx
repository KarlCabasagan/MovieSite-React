...
function SearchInput() {
    ...
    const handleChange = (event) => {
        ...
        event.target.value ? '' : setSearchInputField(event.target.value)
    }
    ...
    return(
        <form onSubmit={handleSubmit} className="w-[90%] mx-auto mb-10">   
            ...
            <div className="relative">
                ...
                <input onChange={handleChange} type="search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-[#F4EEFF] focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Movies, TV Shows..." required />
